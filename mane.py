...
async def get_username(message: types.Message, state: FSMContext):
    ...
    apps.Db().insert_message(message.from_user.id, message.text, a, "Telegram")
...
async def mes_answer(message: types.Message):
    ...
    apps.Db().insert_message(message.from_user.id, datetime.datetime.now(), message.text, "Telegram")
